    ...
    return (
        <div className="space-y-8 animate-fade-in">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                {[
                    { label: "Total Applications", value: "24", icon: FileText, color: "text-blue-400", bg: "bg-blue-400/10" },
                    { label: "Interviews", value: "3", icon: Briefcase, color: "text-purple-400", bg: "bg-purple-400/10" },
                    { label: "Success Rate", value: "12%", icon: TrendingUp, color: "text-green-400", bg: "bg-green-400/10" },
                    { label: "Credits Left", value: "14", icon: Clock, color: "text-orange-400", bg: "bg-orange-400/10" },
                ].map((stat, i) => (
